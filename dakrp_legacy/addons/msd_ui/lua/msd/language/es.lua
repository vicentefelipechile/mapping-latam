MSD.Language["es"] = {
	...
	check_fpr_errors = "Verificar errores",
	enter_description = "Ingresar descripción",
	cooldown_ok = "Retraso si hay exito",
	cooldown_fail = "Retraso si hay falla",
	...
	e_blank_dis = "Dejar en blanco para desactivar",
	e_blank_default = "Dejar en blanco para usar predeterminado",
	e_url = "Ingresar URL",
	e_model = "Ingresar ruta del modelo",
	e_material = "Ingresar ruta del material",
	e_wep_class = "Ingresar ruta del arma",
	e_ent_class = "Ingresar ruta de la entidad",
	e_veh_class = "Ingresar ruta del vehículo",
	e_npc_class = "Ingresar tipo de NPC",

	select_ammo = "Munición seleccionada",
	amount_ammo = " Cantidad de munición",
	disable_phys = "Desactivar fisicas.",
	none = "Ninguno",
	...
	swap = "Intercambiar",
	swapmod = "Intercambiar mod habilitado. Click para desactivar",
	copy_from_ent = "Copiar la entidad que miras",
	set_pos_self = "Establecer en tu posición",
	...
	in_sec = "En segundos",
	def_units = "Predeterminado %s unidades", -- "350 unidades por defecto" leave %s as is
	def_seconds = "Predeterminado %s segundos", -- "10 segundos por defecto" leave %s as is
	...
	mat_default = "Dejar en blanco para material predeterminado",
	...
	q_ent_draw = "Distancia de dibujo de la entidad",
	q_loop_stop_key = "Tecla para detener misión en bucle",
	q_hold_key_stop = "Para cancelar la misión, manten presionado [%s]", -- Para detener la mision mantenga apretado [P]
