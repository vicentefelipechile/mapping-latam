return {
	...
	Phrases = function() return {
		...
		Logs = {
			...
			picked_up_weapon                               = "{1} obtuvo un arma {2}",
			picked_up_item                                 = "{1} obtuvo un item {2}",
			...
			darkrp_money_picked_up                         = "{1} obtuvo {2}",
			darkrp_money_picked_up_owned                   = "{1} obtuvo {2} soltado por {3}",
			...
			darkrp_picked_up_money                         = "{1} obtuvo {2}",
			darkrp_picked_up_money_dropped_by              = "{1} obtuvo {2} que soltó {3}",
		...
		pvp_dmgtype_club = "%u de daño por ataque contundente",
		pvp_dmgtype_shock = "%u de daño por electrocutamiento",
		pvp_dmgtype_sonic = "%u de daño por onda sonica",
		...
		pvp_dmgtype_airboat = "%u de daño por arma de hidrodeslizador",
		pvp_dmgtype_buckshot = "%u de daño por bala de escopeta",
		pvp_dmgtype_sniper = "%u de daño por bala de rifle francotirador",
