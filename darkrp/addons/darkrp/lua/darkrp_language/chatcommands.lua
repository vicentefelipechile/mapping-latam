...
local descriptions = {
    ...
    ["moneydrop"]             = "Deja caer dinero en el suelo.",
    ["name"]                  = "Establece tu nombre en Rol",
    ["nick"]                  = "Establece tu nombre en Rol",
    ["ooc"]                   = "Chat Global del Server",
    ["placelaws"]             = "Coloca un panel de leyes.",
