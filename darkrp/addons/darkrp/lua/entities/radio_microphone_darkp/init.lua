...
hook.Add("GravGunOnPickedUp" , "HandleMicrophone" , function(ply , ent)
    if ent:GetClass() == "radio_microphone_darkp" then
        ang = Angle(0, 0, 0)
        ent:SetAngles(ang)
    end
end)

hook.Add("GravGunOnDropped" , "HandleMicrophone" , function(ply , ent)
    if ent:GetClass() == "radio_microphone_darkp" then
        ang = Angle(0, 0, 0)
        ent:SetAngles(ang)
    end
