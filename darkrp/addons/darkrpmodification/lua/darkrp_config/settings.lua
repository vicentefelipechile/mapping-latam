...
GM.Config.printeroverheatchance         = 10000
...
GM.Config.PocketBlacklist = {
    ...
    ["ch_farming_buyer"] = true,
    ["ch_farming_crate"] = true,
    ...
    ["ch_farming_plant_hole"] = true,
    ["ch_farming_plant_sack"] = true,
    ...
    ["ch_farming_util_battery"] = true,
    ["ch_farming_util_dirt"] = true,
...
GM.Config.hudText = "Soy un sicario.\nPresiona E para pedirme un Hit"
