			...
			if not self:GetShowToMuchPowerWarning() then
				if not self:GetShowNoFuelWarning() then
					...
					if self:GetPowerConsumpsion() > 0 then
						draw.RoundedBox(2, -200 + 70 + 2, 4 + 2, (400 - 70 - 4) * (self:GetPowerConsumpsion()/ BM2CONFIG.GeneratorPowerOutputVip), 60-8 - 4, Color(200,200,0, 255 * alpha))
					end
					
					local powerLevel = __round(self:GetPowerConsumpsion(), 2)

					draw.SimpleText((powerLevel*100).."/"..(BM2CONFIG.GeneratorPowerOutputVip * 100).."W", "BM2GeneratorFont", 45, ((60-8-4)/2) + 6, Color(0,0,0, 255 * alpha), 1, 1)
					draw.SimpleText((powerLevel*100).."/"..(BM2CONFIG.GeneratorPowerOutputVip * 100).."W", "BM2GeneratorFont", 44, ((60-8-4)/2) + 5, Color(255,255,255, 255 * alpha), 1, 1)
					...
					draw.RoundedBox(2, -200 + 70 + 2, 4 + 2 + 70, (400 - 70 - 4) * (self:GetFuelLevel()/ 4000), 60-8 - 4, Color(255,165,0,  255 * alpha))
					draw.SimpleText(self:GetFuelLevel().."/4000 L", "BM2GeneratorFont", 45, ((60-8-4)/2) + 6 + 70, Color(0,0,0, 255 * alpha), 1, 1)
					draw.SimpleText(self:GetFuelLevel().."/4000 L", "BM2GeneratorFont", 44, ((60-8-4)/2) + 5 + 70, Color(255,255,255, 255 * alpha), 1, 1)
				else
					surface.SetMaterial(warningMaterial)
					surface.SetDrawColor(Color(255,80,80, 255))
					surface.DrawTexturedRect(-80, -20, 160, 160)

					draw.SimpleText("Sin Combustible!", "BM2GeneratorFont", 0, 170, Color(0,0,0, 255), 1, 1)
					draw.SimpleText("Sin Combustible!", "BM2GeneratorFont", -1, 170 - 1, Color(255,255,255, 255), 1, 1)

					draw.SimpleText("Consigue algo de combustible.", "BM2GeneratorFont", 0, 170 + 35, Color(0,0,0, 255), 1, 1)
					draw.SimpleText("Consigue algo de combustible.", "BM2GeneratorFont", -1, 170 - 1 + 35, Color(255,255,255, 255), 1, 1)
				...
				draw.SimpleText("Demasiado voltaje usado!", "BM2GeneratorFont", 0, 170, Color(0,0,0, 255), 1, 1)
				draw.SimpleText("Demasiado voltaje usado!", "BM2GeneratorFont", -1, 170 - 1, Color(255,255,255, 255), 1, 1)

				draw.SimpleText("Porfavor desconecta algunos aparatos o encontrar otra fuente de energia.", "BM2GeneratorFont", 0, 170 + 35, Color(0,0,0, 255), 1, 1)
				draw.SimpleText("Porfavor desconecta algunos aparatos o encontrar otra fuente de energia.", "BM2GeneratorFont", -1, 170 - 1 + 35, Color(255,255,255, 255), 1, 1)
